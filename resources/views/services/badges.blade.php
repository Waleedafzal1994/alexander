                ...
                <div class="col-sm-12">
                    ...
                    <div class="post-box">
                        <div class="central-meta item post-item-box border-0 p-0" style="display: inline-block;" id="post-item-box-1">
                            ...
                            <div class="badge-cards px-2 row d-flex align-items-center flex-wrap">
                                @if($totalOrders >= 50 && $totalOrders < 100) <div class="card badge-card border-0 py-4 my-3">
                            ...
                            @elseif($totalOrders >= 100 && $totalOrders < 500) <div class="card badge-card border-0 py-4 my-3">
                                <div class="card-body text-center">
                                    <div class="badge-img">
                                        <img src="/imgs/elitegpbadge.png" width="220" alt="">
                                    </div>
