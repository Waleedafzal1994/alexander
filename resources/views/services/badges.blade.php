<div class="card mt-2 p-0">
                    ...
                    <div class="post-box">
                        <div class="central-meta item post-item-box border-0 p-0" style="display: inline-block;" id="post-item-box-1">
                            ...
                            <div class="badge-cards row d-flex align-items-center justify-content-around flex-wrap">
                                @if($totalOrders >= 50 && $totalOrders < 100) <div class="card badge-card border-0 py-4 my-4">
                            ...
                            @elseif($totalOrders >= 100 && $totalOrders < 500) <div class="card badge-card border-0 py-4 my-4">
                                <div class="card-body text-center">
                                    <div class="badge-img">
                                        <img src="/imgs/elitegpbadge.png" width="220" alt="">
                                    </div>
    ...
    <div class="badge-cards d-flex algin-items-center justify-content-around flex-wrap">
        <div class="card badge-card border-0 py-4 my-4">
            <div class="card-body text-center">
                <div class="badge-img">
                    <img src="/imgs/elitegpbadge.png" width="220" alt="">
