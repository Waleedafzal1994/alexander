        ...
        <div class="d-flex justify-content-between">
                    ...
                    <div class="card-body p-0 m-0">
                            ...
                            <div class="mt-3 mx-0 d-flex justify-content-between img-two-btns-row">
                                ...
                                <div class="center-img">
                                    <div class="">
                                        <!-- <a href="#" class="pop"> -->
                                        <div class="lightbox lightbox-user-gallery">
                                            <img id="circle-profile-pic" src='{{ $user->getProfilePicture() }}' alt="" class="pointer img-fluid profile-image-v2 zoom-clicked-img" />
                                            <!-- </a> -->
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="profile-info mt-2 pr-3 mb-2 profile-name-top">
                            ...
                            <div class="profile-about">
                                <div class="pl-3">
                                    <div class=" profile-section-two">
                                        <div class="review-body text-center">
                                            {{ $user->primary_language ?: 'N/A' }}
                                            {{ !empty($user->secondary_language) ? ' 1/ '.$user->secondary_language : '' }}
                                        </div>
                                    </div>
                                ...
                                <p class="text-black pl-3 more-description text-justify mt-3"> {{ !empty($user->description) ? $user->description : 'N/A' }} </p>
            ...
            <div class="profile-about mt-3">
                ...
                <div class="pl-3 social_icons mb-4">
                    @if(!empty($user->facebook_profile) || !empty($user->instagram_profile) || !empty($user->twitch_profile) || !empty($user->tiktok_profile))


                    @if(!empty($user->facebook_profile))
                    ...
                    @if(!empty($user->instagram_profile))
                    <a href="{{$user->instagram_profile}}" target=_blank>
                        <i class="fab fa-instagram text-white"></i>
                    </a>
                    @endif

                    @if(!empty($user->twitch_profile))
                    <a href="{{$user->twitch_profile}}" target=_blank>
                        <i class="fab fa-twitch text-white"></i>

                    </a>
                    @endif

                    @if(!empty($user->tiktok_profile))

                    <a href="{{$user->tiktok_profile}}" target=_blank>
                ...
                <p class="pl-3 mb-4 text-style-4 color-primary head-style-fst">ID: <br>{{ str_pad($user->id, 5, '0', STR_PAD_LEFT) }}</p>
...
<div class="mainBody">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-tab-nav">
                            <ul class="nav nav-tabs nav-custom-nav" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false" href="#profile">
                                        Timeline
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                ...
                                <li class="nav-item ml-auto" role="presentation">
                                    <a class="nav-link" id="badges-tab" href="/edit-profile/{{$user->id}}">
                                        Edit
                                    </a>
                                </li>
                            </ul>
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade posttimeline active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            @include('services.user_create_post', [
            'service' => $user,
            ])
        </div>
